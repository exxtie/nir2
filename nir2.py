...
### Вывод указанного содержимого таблицы на экран
def showData(data):
...
### Вывод меню и получение желаемого действия пользователя
def menu():
...
### Получение списка содержимого таблицы
def dbData(dbName):
